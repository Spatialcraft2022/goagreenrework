...
} from "./chunk-E7MENCL6.js";
import {
  XYZ_default
} from "./chunk-HC23LSXP.js";
import {
  DECIMALS,
  Image_default as Image_default3,
  defaultImageLoadFunction,
  getRequestExtent
} from "./chunk-D35BCCPS.js";
import {
  ...
  getForProjection,
  nullTileUrlFunction
} from "./chunk-I6IBZGBF.js";
import {
  appendParams,
  expandUrl,
  pickUrl,
  renderXYZTemplate
} from "./chunk-RRARG6EX.js";
import {
  VectorRenderTile_default,
  VectorTile_default
} from "./chunk-24IVAINU.js";
import {
  TileQueue_default
} from "./chunk-GZT6BJF6.js";
import {
  orthographic,
  scale as scale3,
  translate,
...
addDecoder(7, () => import("./jpeg-5XAJQSVI.js").then((m) => m.default));
addDecoder([8, 32946], () => import("./deflate-CECXHXME.js").then((m) => m.default));
addDecoder(32773, () => import("./packbits-UPOPB7PA.js").then((m) => m.default));
addDecoder(
  34887,
  () => import("./lerc-BLTVIDPJ.js").then(async (m) => {
    await m.zstd.init();
    return m;
  }).then((m) => m.default)
);
...
//# sourceMappingURL=chunk-DPRIO6YB.js.map
